...
$application->setOption('repositoryUrl', 'git@github.com:langeland/mimer-distribution.git');
...
$application->setDeploymentPath('/hostroot/sites/langeland/dk.discworld.logger');
